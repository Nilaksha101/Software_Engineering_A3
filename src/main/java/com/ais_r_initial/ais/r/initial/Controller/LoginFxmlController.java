...
public class LoginFxmlController implements Initializable {
    ...
    private boolean isValid(String username, String password, String loginAs) throws Exception {
        ...
        switch (loginAs) {
            case "Administration" -> {
                AdministrationStaff staff = (AdministrationStaff) sendRequest("AdminLogin",username,password);
                return staff != null;
            }
            case "Management" -> {
                ManagementStaff staff = (ManagementStaff) sendRequest("ManagementLogin",username,password);
                return staff != null;
            }
            case "Recruit" -> {
                RecruitDetails staff = (RecruitDetails) sendRequest("RecruitLogin",username,password);
                return staff != null;
            }
            default -> {
                return false;
...
//        dashboard.
    ...
    public void registerManagement(ActionEvent actionEvent) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/ais_r_initial/ais/r/initial/ManagementStaffRegistration.fxml"));
    ...
    public void registerAdmin(ActionEvent actionEvent) {
        try {
            // Load the FXML file for the recruit registration form
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/ais_r_initial/ais/r/initial/AdministrationStaffRegistration.fxml"));
            Parent root = loader.load();
    ...
    public void registerRecruit() {
        try {
            // Load the FXML file for the recruit registration form
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/ais_r_initial/ais/r/initial/RecruitRegistration.fxml"));
            Parent root = loader.load();
