...
public class DashboardFxmlController implements Initializable {
    ...
    public void navigateToOPTRequest(ActionEvent event) {
        ...
        try {
            // Load the FXML file for the staff registration form
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/ais_r_initial/ais/r/initial/RecruitDetailOTPRequestList.fxml"));
            Parent root = loader.load();
...
// Close the dashboard stage
    ...
    public void show() {
        try {
            // Load the FXML file
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/ais_r_initial/ais/r/initial/DashboardFxml.fxml"));
            Parent root = loader.load();
